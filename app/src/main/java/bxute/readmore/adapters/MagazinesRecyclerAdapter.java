...
public class MagazinesRecyclerAdapter extends RecyclerView.Adapter<BookViewHolder> implements OverflowIconTapListener {

    private ArrayList<BookModel> books;
    private Context context;

    public MagazinesRecyclerAdapter(Context context) {
    ...
    private void addToFavorite(BookModel book) {
